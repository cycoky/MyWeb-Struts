 ...
 * @版本 1.0
 * @创建者 chenyang
 * @创建时间 2015-1-14 下午4:05:16
 * @版权所有 ©2015 COKY
 * @修改者 chenyang
 * @修改时间 2015-1-14 下午4:05:16
 * @修改描述
 */
public class SecurityEncode {
	...
	public static void main(String[] args) {
		String pwd = "123456";
		try {
			System.out.println(encoderByMd5(pwd));
			System.out.println(encoderByMd5("coky"));
			System.out.println(encoderByMd5("chenyang"));
